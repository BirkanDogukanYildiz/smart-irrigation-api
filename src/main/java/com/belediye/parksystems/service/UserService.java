...
import com.belediye.parksystems.exception.UsernameAlreadyExistsException;
...
public class UserService {
    ...
    @Transactional(readOnly = true)
    public com.belediye.parksystems.dto.PageResponseDto<UserResponseDto> searchUsers(int page, int size, Role role, String query) {
